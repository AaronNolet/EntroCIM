...
if [ $fogenabled == "y" ]; then
  mkdir -p ~/entrocim && wget https://nextcloud.heptasystems.com:8443/nextcloud/index.php/s/$NXTFOGLINK/$custcode'_DCLinuxAgent.zip'/download -O ~/entrocim/$custcode'_DCLinuxAgent.zip'
  cd entrocim
