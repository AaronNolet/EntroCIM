...
if [ $fogenabled == "y" ]; then
  mkdir -p ~/entrocim && wget https://nextcloud.heptasystems.com:8443/nextcloud/index.php/s/$NXTFOGLINK/download?path=%2F&files=$custcode_DCLinuxAgent.zip -O ~/entrocim/$custcode_DCLinuxAgent.zip
  cd entrocim
